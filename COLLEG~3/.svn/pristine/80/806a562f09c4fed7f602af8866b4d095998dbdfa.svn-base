...
public class FreeboardController {
	...
	public String updateFreeboardView(@RequestParam("selectedId") int freebid, @ModelAttribute("searchVO") SampleDefaultVO searchVO, Model model) throws Exception {
		FreeboardVO freeboardVO = new FreeboardVO();
		freeboardVO.setFreebid(freebid);
