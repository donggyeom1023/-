...
public class MainNewsController {
	...
	public String updateMainNewsView(@RequestParam("selectedId") String mname, @ModelAttribute("searchVO") SampleDefaultVO searchVO, Model model) throws Exception {
		MainNewsVO mainnewsVO = new MainNewsVO();
		mainnewsVO.setMname(mname);
